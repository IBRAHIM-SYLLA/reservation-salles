...
class User
{
    ...
    public function register($_login, $_password)
    {
        $this->login    = $_login;
        ...
        if(isset($this->login) && isset($this->email)) 
        {
            ...
            $selectQ = "SELECT * FROM utilisateurs WHERE login='$this->login'";
            $insertQ = "INSERT INTO utilisateurs(login, password) VALUES ('$this->login', '$this->password')";
